...
contract LiquidityExamples is IERC721Receiver {
    address public constant DAI = 0x6B175474E89094C44Da98b954EedeAC495271d0F;//address of dai on mainnet
    ...
    // Implementing `onERC721Received` so this contract can receive custody of the erc721 token
    ...
    function mintNewPosition() external returns(uint _tokenId, uint128 liquidity, uint amount0, uint amount1){
        //For this example we will provide equal amounts of liquidity for both assets
        ...
        INonfungiblePositionManager.MintParams memory params = INonfungiblePositionManager.MintParams({
            ...
            token1:USDC,
            fee:poolFee,
            // By using TickMath.MINT_TICK and TickMath.MAX_TICK,
    ...
    function collectAllFees() external returns(uint256 amount0, uint256 amount1){
        ...
        //alternatively can set recipient to msg.sender and avoid another transaction in send to Owner
